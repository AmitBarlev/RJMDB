...
public class AddressConverterTest {
    ...
    public void convert_sanity_identicalStrings() {
        UserSignupInfo info = new UserSignupInfo("a", "b", "c", "d", "e");
    ...
    public void convert_countryIsNull_identicalStrings() {
        UserSignupInfo info = new UserSignupInfo("a", "b", null, "d", "e");
    ...
    public void convert_cityIsNull_identicalStrings() {
        UserSignupInfo info = new UserSignupInfo("a", "b", "c", null, "e");
    ...
    public void convert_addressIsNull_identicalStrings() {
        UserSignupInfo info = new UserSignupInfo("a", "b", "c", "d", null);
